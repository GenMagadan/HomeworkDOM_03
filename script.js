...
document.addEventListener('click', e => {
   ...
   console.log(`Класс "super_element" ${text} в элементе "${e.target.tagName.toLowerCase()}".`);
});
...
// --В 5 задание querySelector напрямую обращается к элементу 'ul', после чего идет цикл if.
